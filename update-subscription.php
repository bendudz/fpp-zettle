...
if (count($pluginJson['subscriptions']) == 0) { ?>
  ...
  $subscription_uuid = isset($pluginJson['subscriptions']['uuid']) ? $pluginJson['subscriptions']['uuid'] : '';
  $destination = isset($pluginJson['subscriptions']['destination']) ? $pluginJson['subscriptions']['destination'] : '';
  $contactEmail = isset($pluginJson['subscriptions']['contactEmail']) ? $pluginJson['subscriptions']['contactEmail'] : '';
  ?>
  ...
  <div id="global" class="settings">
    ...
    <form id="update_subscription" action="" method="post">
      <input type="hidden" name="organization_uuid" id="organization_uuid"
        value="<?php echo $pluginJson['organizationUuid']; ?>">
      <input type="hidden" name="subscription_uuid" id="subscription_uuid" value="<?php echo $subscription_uuid; ?>">
      <div class="container-fluid settingsTable settingsGroupTable">
        <div class="row">
          ...
          <div class="printSettingFieldCol col-md">
            <input type='text' id='destination' value="<?php echo $destination; ?>" placeholder="Wormhole Address"
              required autofocus style="width: 97%;">
            <img id='HostName_img' title='This is the url that zettle will talk to' src='images/redesign/help-icon.svg'
              class='icon-help'>
        ...
        <div class="row">
          ...
          <div class="printSettingFieldCol col-md">
            <input type='email' id='contactEmail' value="<?php echo $contactEmail; ?>" required style="width: 97%;">
            <img id='contactEmail_img' title='Used if there is an error' src='images/redesign/help-icon.svg'
              class='icon-help'>
